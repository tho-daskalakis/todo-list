...
const taskManager = (() => {
  ...
  function createTask() {
    ...
    task.editDiv = _view_displayManager__WEBPACK_IMPORTED_MODULE_2__.displayManager.taskEditDialog(task, task.text);
    ...
    console.log(_projects_projectManager__WEBPACK_IMPORTED_MODULE_0__.projectManager.getCurrentProject().getTasks());
...
function taskEditDialog(task, taskText) {
  ...
  editBtn.addEventListener('click', (e) => {
    ...
    task.displayDiv = _displayManager__WEBPACK_IMPORTED_MODULE_3__.displayManager.taskDisplay(task.text);
...
function updateProjectContent() {
  ...
  _projects_projectManager__WEBPACK_IMPORTED_MODULE_0__.projectManager.getCurrentProject()
    .getTasks()
    .forEach((task) => {
      main.appendChild(_displayManager__WEBPACK_IMPORTED_MODULE_2__.displayManager.taskDisplay(task.text));
    });
}
